...
model_edl.save('saved_model/model_edl2')
...
for i in tqdm.tqdm(range(n)):
  ...
  #  smoothgrad_mask_grayscale = saliency.VisualizeImageGrayscale(smoothgrad_mask_3d)
   ...
   if u > uncertainty_threshold_upper:
     saliency_im_uncertain.append(smoothgrad_mask_grayscale)
   elif u < uncertainty_threshold_lower:
...
tf.data.experimental.save(dataset_secondary, 'saved_data/saved_data2')
